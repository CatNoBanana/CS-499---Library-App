...
Thoughout the Computer Science program, I learned the importance of collaboration and communication in software development. During this capstone project, I demonstrated collaborative development practices through a formal code review process, detailed documentation, and code commentary. These activities mirror industry practices that allow development teams and stakeholders to evaluate software, understand design decisions, and make informed decisions regarding future enhancements.
The capstone project also strengthened my ability to communicate technical information through oral, written, and visual formats. My code review video provided a verbal explanation of the application's functionality and enhancement plans, while the narratives and project documentation communicated technical concepts in written form. This GitHub page ePortfolio further demonstrates visual communication by presenting project artifacts in an organized and professional manner for both technical and non-technical audiences.
...
Throughout this capstone project, I demonstrated collaborative software development practices through the creation of a detailed code review and extensive code documentation. The code review process allowed me to evaluate the existing implementation, identify areas for improvement, and communicate enhancement plans in a manner similar to professional peer-reviewed environments. Additionally, I added meaningful comments throughout the codebase to improve maintainability and ensure future developers could understand the purpose and functionality of the application. These practices support collaboration, knowledge sharing, and informed decision making among diverse stakeholders.

I also demonstrated professional communication skills through multiple forms of technical communication. The code review video provided an oral explanation of the application's functionality and enhancement strategy. Written communication was demonstrated through the creation of enhancement narratives, project documentation, code commentary, and this comprehensive README file. Visual communication was incorporated through the design and organization of the GitHub ePortfolio, which presents project artifacts in a clear and accessible manner. Together, these elements ensure that technical information is effectively communicated to both technical and non-technical audiences.

In conclusion, this capstone project demonstrates my growth throughout the Computer Science program by showcasing my ability to analyze an existing software application, identify opportunities for improvement, implement meaningful enhancements, and document the development process. Through improvements in software design and engineering, algorithms and data structures, and database management, I transformed a basic inventory application into a secure and scalable multimedia library system.
